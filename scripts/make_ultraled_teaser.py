...
def main():
    # 加载视频
    input_clip = VideoFileClip("projects/ultraled/assets/video_demo/B/input1.mp4")
    ours_clip = VideoFileClip("projects/ultraled/assets/video_demo/A/output1.mp4")
    ...
    # 写入输出GIF文件
    output_path = "assets/paper_teaser/ultraled.gif"
